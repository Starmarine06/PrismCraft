	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<PrismColoredBlockEntity>> PRISM_COLORED =
		BLOCK_ENTITIES.register("prism_colored", () ->
			new BlockEntityType<>(PrismColoredBlockEntity::new,
				...
				ModBlocks.PRISM_QUARTZ_BLOCK.get(),
				ModBlocks.PRISM_QUARTZ_PILLAR.get(),
				ModBlocks.PRISM_CHISELED_QUARTZ.get(),
				ModBlocks.PRISM_SANDSTONE.get(),
				ModBlocks.PRISM_CUT_SANDSTONE.get(),
				ModBlocks.PRISM_CHISELED_SANDSTONE.get(),
				ModBlocks.PRISM_CHISELED_RED_SANDSTONE.get(),
				ModBlocks.PRISM_SMOOTH_STONE.get(),
				ModBlocks.PRISM_COBBLESTONE.get(),
