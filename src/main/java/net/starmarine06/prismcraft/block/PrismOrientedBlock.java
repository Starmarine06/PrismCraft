...
public class PrismOrientedBlock extends RotatedPillarBlock implements EntityBlock, IPrismColoredBlock {
    public static final MapCodec<PrismOrientedBlock> CODEC = simpleCodec(PrismOrientedBlock::new);

    public PrismOrientedBlock(Properties properties) {
        super(properties);
    }
