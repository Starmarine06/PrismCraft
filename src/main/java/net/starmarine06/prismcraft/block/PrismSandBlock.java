...
public class PrismSandBlock extends BaseEntityBlock implements IPrismColoredBlock {
    public static final MapCodec<PrismSandBlock> CODEC = simpleCodec(PrismSandBlock::new);

    public PrismSandBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
